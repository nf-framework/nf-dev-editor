...
export class WrapElementCommand extends DomCommand {
    command = 'wrap-element';
    /** @type String */
    element
    constructor(obj) {
        super(obj);
...
export class DuplicateElementCommand extends DomCommand {
...
export class ChangeAttributeCommand extends DomCommand {
    command = 'change-attribute';
    attribute
    value
    constructor(obj) {
        super(obj);
...
export class ChangeTextNodeCommand extends DomCommand {
    command = 'change-text-node';
    textPath
    value
    constructor(obj) {
        super(obj);
