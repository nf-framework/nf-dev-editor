...
import plGridLayoutConfig from './components/pl-grid-layout.js';
import commonConfigs from './components/pl-common-components.js';

const configs = new Map(
  [plFlexLayoutConfig, plActionConfig, plButtonConfig, plGridConfig, plGridColumnConfig, plGridLayoutConfig, ...commonConfigs]
